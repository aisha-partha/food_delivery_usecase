...
if __name__ == "__main__":
    ...
    st.title("Food Delivery Data Analyzer - LLM App Using LangChain")
    
    doc_text = ''' Sample questions to ask:\n
    What data is contained in this dataset?\n
    How many deliveries were made in each city type?\n
    What is the average delivery time for different order types?\n
    How does weather affect delivery times?\n
    How does vehicle condition impact delivery time?\n
    How many deliveries were made in major cities?\n
    Which areas have the highest delivery density?\n
    Can you show the distribution of deliveries across cities?'''
    ...
    if prompt:
            ...
            response = ask_dataframe_agent(prompt)
            question = st.chat_message("user")
            question.write(prompt)
    ...
    #with st.form("my_form"):
        ...
        #if submitted:
        #    response = ask_dataframe_agent(text)
        #    st.info(response)
